...
class PrimaryHomeActivity : ComponentActivity() {
    ...
    override fun dispatchKeyEvent(event: KeyEvent): Boolean {
        if (event.action == KeyEvent.ACTION_DOWN && event.keyCode == KeyEvent.KEYCODE_BUTTON_X) {
    ...
    if (showDialog && pendingIntent != null) {
        AlertDialog(
            ...
            confirmButton = {
                Row {
                    TextButton(onClick = {
                        DisplayAppLauncher.launchOnRole(activity, pendingIntent!!, DisplayRole.INTERACTION)
                        showDialog = false
                    }) {
                        Text("Interaction")
                    }
                    ...
                    TextButton(onClick = {
                        DisplayAppLauncher.launchOnRole(activity, pendingIntent!!, DisplayRole.PRESENTATION)
                        showDialog = false
                    }) {
                        Text("Presentation")
                    }
